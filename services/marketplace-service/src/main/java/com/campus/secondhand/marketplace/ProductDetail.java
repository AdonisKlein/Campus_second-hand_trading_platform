...
public interface ProductDetail {
    ...
    enum Action { CHAT_SELLER, REQUEST_PURCHASE, VIEW_PURCHASE_REQUEST, MANAGE_LISTING, REPORT_ITEM }
    record View(Long id, String title, String category, BigDecimal price, String description,
                ...
                ItemModerationStatus moderationStatus, LocalDateTime createdAt, Long sellerId,
                Seller seller, Viewer viewer, List<RelatedItem> sellerItems) { }
    ...
    record PurchaseRequest(Long id, String status, LocalDateTime expiresAt) { }
