...
class FreshMySqlIT {
    ...
    static final MySQLContainer<?> MYSQL = new MySQLContainer<>("mysql:8.4")
            .withDatabaseName("marketplace_it").withUsername("marketplace").withPassword("marketplace-pass");
    ...
    void freshDatabaseRunsAllOwnedMigrations() {
        assertThat(ownedTableCount("items", "item_tags", "messages", "searchable_user_projection",
                "marketplace_event_inbox", "marketplace_event_outbox")).isEqualTo(6);
