...
class FreshMySqlIT {
    ...
    static final MySQLContainer<?> MYSQL = new MySQLContainer<>("mysql:8.4")
            .withDatabaseName("governance_it").withUsername("governance").withPassword("governance-pass");
    ...
    void freshDatabaseRunsAllOwnedMigrations() {
        assertThat(ownedTableCount("content_reports", "report_actions", "outbox_events", "inbox_events"))
                .isEqualTo(4);
