...
public interface DirectChat {
    ...
    record ConversationView(String id,Long itemId,String itemTitle,String itemImageUrl,BigDecimal itemPrice,String itemStatus,Long otherUserId,String otherNickname,
